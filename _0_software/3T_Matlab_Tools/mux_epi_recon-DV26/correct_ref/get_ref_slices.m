...
num_echoes = header.nslices / header.npasses / header.image_slquant;  % number of echoes in reference scan
ref_nslices = header.image_slquant; % slquant in image header
ref_nslices = ref_nslices * num_echoes;   % number of slices in ref file in the slice loop
