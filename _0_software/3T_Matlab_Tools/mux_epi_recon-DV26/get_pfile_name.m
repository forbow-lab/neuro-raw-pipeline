...
%   ref        - Filename of the ref.dat or ref.h5 file associated with the p-file.
...
if isdir(d)
    pfile_dir = d;
    pfiles_in_dir = dir(fullfile(pfile_dir, '2*_E*_P*.7'));
...
% ref.dat file (CVB comment out to avoid interference with orchestra
ref = get_pfile_associated_file(pfile_dir, pfile_name, 'ref.h5');
