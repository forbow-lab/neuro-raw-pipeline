...
use_previous_solvemtx = isfield(p, 'solve_mtx') && ~isempty(p.solve_mtx) && ~(p.RT_flag && p.cal_flag);    % True: solve_mtx is already saved in p in previous passes, only used in real-time recon
