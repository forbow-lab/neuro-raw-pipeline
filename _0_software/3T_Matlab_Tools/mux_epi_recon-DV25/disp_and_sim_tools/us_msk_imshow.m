function [mtx, cmap] = us_msk_imshow(us_msk, ny, dispfig, axison, kydir, nomegaz)
%
...
%
% Outputs
%   mtx     - A structure that contains matrices for display. Fields include:
%             omegaz - omegaz values to display.
%             omegay - omegay values to display.
%             mtx - Matrices(i.e. images corresponding to the undersampling patterns) to display.
