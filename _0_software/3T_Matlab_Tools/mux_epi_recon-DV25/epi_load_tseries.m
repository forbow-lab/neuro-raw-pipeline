...
if (~p.RT_flag && (p.calc_snr_pmr || p.calc_sense_rsnr)) || ...
        (p.RT_flag && p.cal_flag && (strcmp(p.mux_recon_method, 'slice-grappa') || strcmp(p.mux_recon_method, 'split-slice-grappa')))  % slice-grappa recon needs raw data to synthesize muxed data point for kernel fitting
