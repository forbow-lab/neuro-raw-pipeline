 ...
 executing the application)
   -to run the shell script, type
    ...
    /mathworks/home/application/v91, run the shell script as:
       ...
       ./run_muxrecon.sh /mathworks/home/application/v91
...
-The Macintosh bundle directory structure muxrecon.app 
   -this can be gathered up using the zip command 
    zip -r muxrecon.zip muxrecon.app
    or the tar command 
    tar -cvf muxrecon.tar muxrecon.app
-This readme file 
